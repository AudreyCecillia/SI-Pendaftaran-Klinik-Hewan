        ...
        @endif
            ...
            <form class="mt-4" method="POST"  action="/data/addProcess">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="namapemilik" value="{{$data->namapemilik}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="alamatpemilik" class="col-sm-2 col-form-label">Alamat</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="alamatpemilik" value="{{$data->alamatpemilik}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="notelepon" class="col-sm-2 col-form-label">No.Telepon</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="notelepon" value="{{$data->notelepon}}">
                    </div>
                </div>
            ...
            <h5>Data Pasien</h5>
                <form class="mt-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="namahewan" value="{{$data->namahewan}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="umurhewan" class="col-sm-2 col-form-label">Umur</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="umurhewan" value="{{$data->umurpemilik}}">
                        </div>
                    </div>
                    <fieldset class="row mb-3">
                        <legend class="col-form-label col-sm-2 pt-0">Jenis</legend>
                        <div class="col-sm-10">
                            <div class="row mb-3" id="jenishewan" value="{{$data->jenishewan}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="rashewan" value="{{$data->rashewan}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="warnahewan" class="col-sm-2 col-form-label">Warna</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="warnahewan" value="{{$data->warnahewan}}">
                        </div>
                    </div>
